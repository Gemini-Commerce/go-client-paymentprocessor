...
// checks if the PaymentprocessorPostalAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentprocessorPostalAddress{}

// PaymentprocessorPostalAddress Represents a postal address, e.g. for postal delivery or payments addresses. Given a postal address, a postal service can deliver items to a premise, P.O. Box or similar. It is not intended to model geographical locations (roads, towns, mountains).  In typical usage an address would be created via user input or from importing existing data, depending on the type of process.  Advice on address input / editing:  - Use an i18n-ready address widget such as    https://github.com/google/libaddressinput) - Users should not be presented with UI elements for input or editing of   fields outside countries where that field is used.  For more guidance on how to use this schema, please see: https://support.google.com/business/answer/6397478
type PaymentprocessorPostalAddress struct {
...
func NewPaymentprocessorPostalAddress() *PaymentprocessorPostalAddress {
	this := PaymentprocessorPostalAddress{}
	return &this
}

// NewPaymentprocessorPostalAddressWithDefaults instantiates a new PaymentprocessorPostalAddress object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPaymentprocessorPostalAddressWithDefaults() *PaymentprocessorPostalAddress {
	this := PaymentprocessorPostalAddress{}
	return &this
}

// GetRevision returns the Revision field value if set, zero value otherwise.
func (o *PaymentprocessorPostalAddress) GetRevision() int32 {
...
func (o *PaymentprocessorPostalAddress) GetRevisionOk() (*int32, bool) {
	if o == nil || IsNil(o.Revision) {
		return nil, false
	}
...
func (o *PaymentprocessorPostalAddress) SetRevision(v int32) {
	o.Revision = &v
}

// GetRegionCode returns the RegionCode field value if set, zero value otherwise.
func (o *PaymentprocessorPostalAddress) GetRegionCode() string {
...
// and a boolean to check if the value has been set.
func (o *PaymentprocessorPostalAddress) GetRegionCodeOk() (*string, bool) {
	if o == nil || IsNil(o.RegionCode) {
		return nil, false
	}
...
func (o *PaymentprocessorPostalAddress) SetRegionCode(v string) {
	o.RegionCode = &v
}

// GetLanguageCode returns the LanguageCode field value if set, zero value otherwise.
func (o *PaymentprocessorPostalAddress) GetLanguageCode() string {
...
// and a boolean to check if the value has been set.
func (o *PaymentprocessorPostalAddress) GetLanguageCodeOk() (*string, bool) {
	if o == nil || IsNil(o.LanguageCode) {
		return nil, false
	}
...
func (o *PaymentprocessorPostalAddress) SetLanguageCode(v string) {
	o.LanguageCode = &v
}

// GetPostalCode returns the PostalCode field value if set, zero value otherwise.
func (o *PaymentprocessorPostalAddress) GetPostalCode() string {
...
// and a boolean to check if the value has been set.
func (o *PaymentprocessorPostalAddress) GetPostalCodeOk() (*string, bool) {
	if o == nil || IsNil(o.PostalCode) {
		return nil, false
	}
...
func (o *PaymentprocessorPostalAddress) SetPostalCode(v string) {
	o.PostalCode = &v
}

// GetSortingCode returns the SortingCode field value if set, zero value otherwise.
func (o *PaymentprocessorPostalAddress) GetSortingCode() string {
...
// and a boolean to check if the value has been set.
func (o *PaymentprocessorPostalAddress) GetSortingCodeOk() (*string, bool) {
	if o == nil || IsNil(o.SortingCode) {
		return nil, false
	}
...
func (o *PaymentprocessorPostalAddress) SetSortingCode(v string) {
	o.SortingCode = &v
}

// GetAdministrativeArea returns the AdministrativeArea field value if set, zero value otherwise.
func (o *PaymentprocessorPostalAddress) GetAdministrativeArea() string {
...
// and a boolean to check if the value has been set.
func (o *PaymentprocessorPostalAddress) GetAdministrativeAreaOk() (*string, bool) {
	if o == nil || IsNil(o.AdministrativeArea) {
		return nil, false
	}
...
func (o *PaymentprocessorPostalAddress) SetAdministrativeArea(v string) {
	o.AdministrativeArea = &v
}

// GetLocality returns the Locality field value if set, zero value otherwise.
func (o *PaymentprocessorPostalAddress) GetLocality() string {
...
// and a boolean to check if the value has been set.
func (o *PaymentprocessorPostalAddress) GetLocalityOk() (*string, bool) {
	if o == nil || IsNil(o.Locality) {
		return nil, false
	}
...
func (o *PaymentprocessorPostalAddress) SetLocality(v string) {
	o.Locality = &v
}

// GetSublocality returns the Sublocality field value if set, zero value otherwise.
func (o *PaymentprocessorPostalAddress) GetSublocality() string {
...
// and a boolean to check if the value has been set.
func (o *PaymentprocessorPostalAddress) GetSublocalityOk() (*string, bool) {
	if o == nil || IsNil(o.Sublocality) {
		return nil, false
	}
...
func (o *PaymentprocessorPostalAddress) SetSublocality(v string) {
	o.Sublocality = &v
}

// GetAddressLines returns the AddressLines field value if set, zero value otherwise.
func (o *PaymentprocessorPostalAddress) GetAddressLines() []string {
...
// and a boolean to check if the value has been set.
func (o *PaymentprocessorPostalAddress) GetAddressLinesOk() ([]string, bool) {
	if o == nil || IsNil(o.AddressLines) {
		return nil, false
	}
...
func (o *PaymentprocessorPostalAddress) SetAddressLines(v []string) {
	o.AddressLines = v
}

// GetRecipients returns the Recipients field value if set, zero value otherwise.
func (o *PaymentprocessorPostalAddress) GetRecipients() []string {
...
// and a boolean to check if the value has been set.
func (o *PaymentprocessorPostalAddress) GetRecipientsOk() ([]string, bool) {
	if o == nil || IsNil(o.Recipients) {
		return nil, false
	}
...
func (o *PaymentprocessorPostalAddress) SetRecipients(v []string) {
	o.Recipients = v
}

// GetOrganization returns the Organization field value if set, zero value otherwise.
func (o *PaymentprocessorPostalAddress) GetOrganization() string {
...
// and a boolean to check if the value has been set.
func (o *PaymentprocessorPostalAddress) GetOrganizationOk() (*string, bool) {
	if o == nil || IsNil(o.Organization) {
		return nil, false
	}
...
func (o *PaymentprocessorPostalAddress) SetOrganization(v string) {
	o.Organization = &v
}

// GetPhoneNumber returns the PhoneNumber field value if set, zero value otherwise.
func (o *PaymentprocessorPostalAddress) GetPhoneNumber() string {
...
// and a boolean to check if the value has been set.
func (o *PaymentprocessorPostalAddress) GetPhoneNumberOk() (*string, bool) {
	if o == nil || IsNil(o.PhoneNumber) {
		return nil, false
	}
...
func (o *PaymentprocessorPostalAddress) SetPhoneNumber(v string) {
	o.PhoneNumber = &v
}

// GetAdditionalInfo returns the AdditionalInfo field value if set, zero value otherwise.
func (o *PaymentprocessorPostalAddress) GetAdditionalInfo() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *PaymentprocessorPostalAddress) GetAdditionalInfoOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.AdditionalInfo) {
...
func (o *PaymentprocessorPostalAddress) SetAdditionalInfo(v map[string]interface{}) {
	o.AdditionalInfo = v
}

func (o PaymentprocessorPostalAddress) MarshalJSON() ([]byte, error) {
...
func (o PaymentprocessorPostalAddress) ToMap() (map[string]interface{}, error) {
...
func (v NullablePaymentprocessorPostalAddress) Get() *PaymentprocessorPostalAddress {
	return v.value
}

func (v *NullablePaymentprocessorPostalAddress) Set(val *PaymentprocessorPostalAddress) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentprocessorPostalAddress) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentprocessorPostalAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentprocessorPostalAddress(val *PaymentprocessorPostalAddress) *NullablePaymentprocessorPostalAddress {
	return &NullablePaymentprocessorPostalAddress{value: val, isSet: true}
}

func (v NullablePaymentprocessorPostalAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentprocessorPostalAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
